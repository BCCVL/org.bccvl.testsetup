...
class GeofabricLayers(WorldClimLayer):
    ...
    dataset_info = {
        ...
        'stream':    {'climate': ('climate', u'Aggregated climate data for the Australian continent between 1921-1995, generated using ANUCLIM version 6.1, for stream segments derived from the national 9 arcsec DEM and flow direction grid version 3. Stream segments refer to all grid cells comprising the stream segment and associated valley bottom.'), 
